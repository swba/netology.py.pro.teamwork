...
def add_user(user_id, f_name, l_name, get_sex, get_relation, get_age, get_city, get_univer, is_closed, get_has_photo, get_music):
...
def add_to_favorite(user_id, favorite_user_id, f_name, l_name, get_sex, get_relation, get_age, get_city, get_univer, is_closed, get_has_photo, get_music):
...
def add_to_black_list(user_id, black_user_id, f_name, l_name, get_sex, get_relation, get_age, get_city, get_univer, is_closed, get_has_photo, get_music)):
