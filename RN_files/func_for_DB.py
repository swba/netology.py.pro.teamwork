...
from DB_VKinder import create_tables, VKuserInfo, MyPreferences, FavoriteUsers, BlackList
import datetime
...
if __name__ == '__main__':
    user_id = ''
    #add_user(user_id)
    #get_my_info(user_id_1)
    #add_my_prefer(user_id)
    #get_my_info(user_id)
    #change_my_prefer(user_id)
    favorite_user_id = ''
    #add_to_favorite(user_id, favorite_user_id)
    #get_my_favorite_info(user_id)
    #get_list_favorite_info(user_id)
    black_user_id = ''
    #add_to_black_list(user_id, black_user_id)
    #get_from_black_list(user_id)
    #get_list_favorite_info(user_id)
    #del_from_black_list(user_id)
